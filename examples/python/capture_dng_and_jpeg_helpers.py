...
def main(args):
    ...
    buffers, metadata = myCamera.switch_mode_and_capture_buffers(capture_config, ["main", "raw"])
    myCamera.helpers.save(myCamera.helpers.make_image(buffers[0], capture_config["main"]), metadata, 
        "capture_dng_and_jpeg_helpers.jpg")
    myCamera.helpers.save_dng(buffers[1], metadata, capture_config["raw"], "capture_dng_and_jpeg_helpers.dng")
